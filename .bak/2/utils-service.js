...
export class UtilsService {
    ...
    async createProject(projectName, v = '1') {
        try {
            ...
            await fs.ensureDir(projectPath);
            const version = v ?? await this.getVersion(projectPath);
    ...
    returnData(data = {}, parmas = { errorCode: ErrorCodes.SUCCESS, errorMessage: '' }) {
        const { errorCode, errorMessage } = parmas
        return {
            header: {
                errorCode,
                errorMessage,
